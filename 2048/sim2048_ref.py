import turtle
from game2048_ref import play2048
# screen parameters
...
# main program
game = play2048(screenSetup,scoreSetup,scoreText,wCor,shapeInfo,colors,screen,pen,scoreObj,tiles) # create the game object
