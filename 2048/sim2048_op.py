...
if mode=="sim":
	scores = list()
	avScor = 0
	game = play2048(screenSetup, scoreSetup, scoreText, wCor, shapeInfo, colors, screen, pen, scoreObj, tiles,\
	                mode)   # create the game object
	N = 1000
	for n in range(N-1):
