...
class play2048():
	...
	def __str__(self):
		...
		output1 = "NUMLIST:\n{:5d} {:5d} {:5d} {:5d}\n{:5d} {:5d} {:5d} {:5d}\n{:5d} {:5d} {:5d} {:5d}\n{:5d} {:5d} {:5d} {:5d}\n".format(
			list1[0][3], \
			list1[1][3], list1[2][3], list1[3][3], list1[0][2], list1[1][2], list1[2][2], list1[3][2], list1[0][1],
			list1[1][1], list1[2][1], list1[3][1], list1[0][0], \
			list1[1][0], list1[2][0], list1[3][0])

		output2 = "NUMLIST OLD:\n{:5d} {:5d} {:5d} {:5d}\n{:5d} {:5d} {:5d} {:5d}\n{:5d} {:5d} {:5d} {:5d}\n{:5d} {:5d} {:5d} {:5d}\n".format(
			list2[0][3], \
			list2[1][3], list2[2][3], list2[3][3], list2[0][2], list2[1][2], list2[2][2], list2[3][2], list2[0][1],
			list2[1][1], list2[2][1], list2[3][1], list2[0][0], \
			list2[1][0], list2[2][0], list2[3][0])

		if self.mode == "user" or self.mode == "viewSim":
			output3 = "STAMPID:\n{:5d} {:5d} {:5d} {:5d}\n{:5d} {:5d} {:5d} {:5d}\n{:5d} {:5d} {:5d} {:5d}\n{:5d} {:5d} {:5d} {:5d}\n".format(
				list3[0][3], \
				list3[1][3], list3[2][3], list3[3][3], list3[0][2], list3[1][2], list3[2][2], list3[3][2], list3[0][1],
				list3[1][1], list3[2][1], list3[3][1], list3[0][0], \
	...
	def strategy(self, games_per_move=500):
		"""
		...
		for n in range(games_per_move):
			if not end(current_board):
				process()
				print(n + 1, 'th sim with end score of', self.currentScore)
